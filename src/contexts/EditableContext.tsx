...
export const EditableProvider: React.FC<EditableProviderProps> = ({ children }) => {
  ...
  const [content, setContent] = useState<Record<string, string>>({
    ...
    // Gallery dish details - updated names and descriptions
    ...
    'gallery.dish.6.description': '',
    'gallery.dish.7.name': 'Milhojas',
    'gallery.dish.7.description': '',
    'gallery.dish.8.name': 'Salmón Roja',
    'gallery.dish.8.description': 'Fideos salteados con ternera y verduras',
    ...
    'parking.title': '🅿️ Parking Gratuito Disponible',
    'parking.message': 'Disfruta de 1 hora de parking gratuito en el Parking Gran Vía de Logroño cuando comas en nuestro restaurante.',
    'parking.cta': 'Hacer Reservación',
    'parking.close': 'Cerrar',
  });
